...
public class NextLevelRequiredItemsNamePlaceholder extends BPPlaceholder {

    @Override
    public String getIdentifier() {
        return "next_level_required_items-name";
    }
    ...
    public String getPlaceholder(Player p, String target, String identifier) {
        ...
        return BPUtils.getRequiredItemsName(requiredItems);
    }
}